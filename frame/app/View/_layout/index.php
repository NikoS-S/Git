...
<?php echo $menu; //MENUHA ?>
            ...
            <div class="contant"><!--посты-->
                <div class="post1">
                    <h2>Шифр Цезаря</h2>
                    <img src="<?php echo SERVER; ?>images/6.png">
                    <p class="post">Шифр Цезаря — это вид шифра подстановки, в котором каждый символ в открытом тексте заменяется символом, находящимся на некотором постоянном числе позиций левее или правее него в алфавите.</p>
                    <!--<img src="img/post1.png">-->
                </div>
                <div class="post2">
                    <h2>RSA</h2>
                    <img src="<?php echo SERVER; ?>images/6.png">
                    <p class="post"> RSA (аббревиатура от фамилий Rivest, Shamir и Adleman) — криптографический алгоритм с открытым ключом, основывающийся на вычислительной сложности задачи факторизации больших целых чисел. </p>
                    <!--<img src="img/post2.png">-->
                </div>
                <div class="post3">
                    <h2>Шифр Виженера</h2>
                    <img src="<?php echo SERVER; ?>images/6.png">
                    <p class="post"> Шифр Виженера (фр. Chiffre de Vigenère) — метод полиалфавитного шифрования буквенного текста с использованием ключевого слова.Этот метод является простой формой многоалфавитной замены. </p>
